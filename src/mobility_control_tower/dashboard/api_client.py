...
ENDPOINTS = {'health': '/v1/health', 'metadata': '/v1/metadata', 'network_overview': '/v1/static/network-overview', 'top_routes': '/v1/static/top-routes', 'hourly_headway': '/v1/static/hourly-headway', 'route_types': '/v1/static/route-types'}
